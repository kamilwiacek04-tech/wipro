const pl = {
    ...
    general: {
        ...
        modalSuccess: {
            ...
            confirm: 'Potwierdź',
            viewOffers: 'Zobacz swoje zapytania →'
        },
        modalError: {
            info: 'Błąd',
    ...
    form: {
        ...
        finishesAndAccessories: {
            ...
            field: {
                ...
                manufactureOfDoors: 'Wykonanie drzwi',
                energyRecovery: 'System odzysku energii',
                antiVibrationSystems: 'Dodatkowe system antywibracyjny',
                cabinMonitoringSystem: 'Instalacja do monitoringu kabiny',
                shaftLighting: 'Oświetlenie szybu',
                identicalDoors: 'Drzwi kabinowe takie same jak przystankowe',
                stopDoors: 'Drzwi przystankowe',
    ...
    account: {
        login: {
            ...
            subtitle: 'Śledź status swojego zapytania ofertowego',
            password: 'Hasło',
            submit: 'Zaloguj się',
        },
        logout: 'Wyloguj się',
        myQuotes: {
            ...
            empty: 'Nie masz jeszcze żadnych zapytań ofertowych.',
            newQuote: 'Złóż nowe zapytanie',
        },
        quoteDetail: {
            submitted: 'Złożone',
            editableNote: 'Twoje zapytanie jest nowe – możesz edytować dane kontaktowe przed weryfikacją.',
            investorData: 'Dane kontaktowe',
            save: 'Zapisz zmiany',
            offers: 'Oferty',
            noOfferYet: 'Oferta jest w przygotowaniu.',
            sentAt: 'Wysłana',
            acceptOffer: 'Akceptuję ofertę',
            rejectOffer: 'Odrzucam ofertę',
        ...
        setPassword: {
            ...
            subtitle: 'Utwórz hasło, aby zalogować się jako',
            password: 'Nowe hasło',
            confirm: 'Powtórz hasło',
            submit: 'Ustaw hasło i zaloguj się',
            mismatch: 'Hasła nie są identyczne.',
            tooShort: 'Hasło musi mieć co najmniej 8 znaków.',
            invalidLink: 'Link jest nieprawidłowy lub wygasł.',
            error: 'Błąd ustawienia hasła. Spróbuj ponownie.',
        },
    },
}
