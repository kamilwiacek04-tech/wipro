...
const FinishesAndAccessories = () => {
    ...
    const onSubmit = (dataCurr: FormFinishesAndAccessories) => {
        ...
        sendData({
            ...
            shaft_width: shaftTempParameters.liftSpecification === 'SHAFT_DIMENSIONS' && shaftTempParameters.shaftLen ? parseInt(String(shaftTempParameters.shaftLen), 10) : undefined,
            shaft_depth: shaftTempParameters.liftSpecification === 'SHAFT_DIMENSIONS' && shaftTempParameters.shaftDep ? parseInt(String(shaftTempParameters.shaftDep), 10) : undefined,
